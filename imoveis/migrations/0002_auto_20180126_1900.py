# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-26 21:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='BRL', max_digits=8),
        ),
        migrations.AddField(
            model_name='build',
            name='condominium_fee_currency',
        ...
        migrations.AlterField(
            model_name='build',
            name='face',
            field=models.CharField(choices=[('N', 'Norte'), ('S', 'Sul'), ('L', 'Leste'), ('O', 'Oeste'), ('-', 'Não informada')], default='-', max_length=1),
        ),
        migrations.AlterField(
            model_name='build',
            name='iptu',
        ...
        migrations.AlterField(
            model_name='build',
            name='owners',
            field=models.ManyToManyField(blank=True, null=True, to='imoveis.Owner'),
        ),
        migrations.AlterField(
            model_name='build',
            name='selling_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='BRL', max_digits=15),
        ),
        migrations.AddField(
            model_name='build',
            name='district',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='imoveis.District'),
        ),
    ]
